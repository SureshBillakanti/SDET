...
public class orangeHRM {
	...
	public void fillJobForm() throws Throwable{
		...
		driver.findElement(By.id("addJobVacancy_hiringManager")).sendKeys("Suresh Billakanti");
	...
	public void candidateForm() throws Throwable{
		Thread.sleep(6000);
		driver.findElement(By.id("addCandidate_firstName")).sendKeys("Lucky2");
		driver.findElement(By.id("addCandidate_lastName")).sendKeys("Billa");
		driver.findElement(By.id("addCandidate_email")).sendKeys("suresh.uce580@gmail.com");
		driver.findElement(By.id("addCandidate_contactNo")).sendKeys("9845931900");
		...
		public void uploadResume() throws Throwable{
			...
			uploadElement.sendKeys("C:\\Users\\SureshBillakanti\\eclipse-workspace\\Cucumber_Live_Project\\src\\test\\resources\\Resume.pdf");
		}
		@And("^Click Save$")
		...
		public void validateCandidature() throws Throwable{
			...
			driver.findElement(By.id("candidateSearch_candidateName")).sendKeys("Lucky2 Billa");
			driver.findElement(By.id("btnSrch")).click();
			Thread.sleep(5000);
			...
			String JobTitle1 = driver.findElement(By.linkText("Lucky2 Billa")).getText();
	    	Assert.assertEquals(JobTitle1, "Lucky2 Billa"); 
		}

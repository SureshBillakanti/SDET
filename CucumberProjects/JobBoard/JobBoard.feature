...
Scenario Outline: Post a job using details passed from the Feature file
    ...
    When User provides the information "testSDETQA01@gmail.com" , "SDET Tester" , "Bengaluru" , "Need a tester with knowledge of JAVA, Python, Selenium, TestNG, ReportNG, Cucumber, Jira, Zypher and Manual Testing" , "testqa111@gmail.com" and "IBM India Pvt Ltd"  
    Then Click submit
...
|testqasdet001@gmail.com|SDET Testers|Bangalore|Need a tester with knowledge of JAVA, Python, Selenium, TestNG, ReportNG, Cucumber, Jira, Zypher and Manual Testing|testqa222@gmail.com|IBM India Pvt Ltd|